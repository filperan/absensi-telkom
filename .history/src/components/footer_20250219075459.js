    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-section logo-section">
          <img src="/telkom.png" alt="Telkom Logo" />
          <img src="/LogoUndipa.png" alt="Undipa Logo" />
          <p className="copyright">
            &copy; {new Date().getFullYear()} Asistensi Mengajar. All rights reserved. Powered By Universitas Dipa Makassar
          </p>
        </div>
